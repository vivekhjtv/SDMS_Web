        ...
        --><div class="container-login100">
                <div class="wrap-login100 hel" style="width: 800px;">
                    ...
                    <div class="row">
                        ...
                        <button class="login100-form-btn" onclick="window.open('http://localhost/sdms/search_faculty.php','_self');">Search Faculty</button>

                    </div>
                    <div class="row">
                        <button class="login100-form-btn" onclick="window.open('http://localhost/sdms/add_student.php','_self');">Add Student</button>
                        <button class="login100-form-btn" onclick="window.open('http://localhost/sdms/add_faculty.php','_self');">Add Faculty</button>

                    </div>
                    <div class="row">
                        <button class="login100-form-btn" onclick="window.open('http://localhost/sdms/delete_student.php','_self');">Delete Student</button>

                        <button class="login100-form-btn" onclick="window.open('http://localhost/sdms/delete_faculty.php','_self');">Delete Faculty</button>

                    </div>
                    <div class="row">
                        <button class="login100-form-btn" onclick="window.open('http://localhost/sdms/show_student.php','_self');">All Student</button>

                        <button class="login100-form-btn" onclick="window.open('http://localhost/sdms/show_faculty.php','_self');">All Faculty</button>
